  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[500px] h-[500px] xl:w-[600px] xl:h-[600px] pointer-events-none opacity-15">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-48 pb-20 lg:pt-72 lg:pb-32">
          <div className="max-w-4xl">
            ...
            <p className="text-xl sm:text-2xl text-stone-500 mb-8">
              {t('heroSubtitle')}<br />
              {t('heroServing')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/products" className="bg-orange-500 hover:bg-orange-600 text-white text-md sm:text-lg py-3 px-6 sm:px-8 rounded-lg font-medium transition-colors shadow-sm">
                {t('shopNow')}
              </Link>
              {!user && (
                <>
                  <Link href="/auth/login" className="bg-white text-stone-700 hover:bg-stone-50 text-md sm:text-lg py-3 px-6 sm:px-8 rounded-lg font-medium transition-colors border border-stone-200 shadow-sm">
                    {t('signIn')}
                  </Link>
                  <Link href="/auth/register?type=b2c" className="bg-white text-stone-700 hover:bg-stone-50 text-md sm:text-lg py-3 px-6 sm:px-8 rounded-lg font-medium transition-colors border border-stone-200 shadow-sm">
                    {t('createAccount')}
                  </Link>
                  <Link href="/auth/register?type=b2b" className="bg-stone-800 text-white hover:bg-stone-900 text-md sm:text-lg py-3 px-6 sm:px-8 rounded-lg font-medium transition-colors shadow-sm">
                    {t('createB2BAccount')}
                  </Link>
                </>
              )}
      ...
      <section className="bg-gray-50 py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 text-center sm:hidden">
            <Link href="/products" className="bg-orange-500 hover:bg-orange-600 text-white py-3 px-8 rounded-lg font-medium transition-colors shadow-sm inline-block">
              {t('viewAllProducts')}
            </Link>
          </div>
        </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="mb-12 lg:mb-0">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <Link href="/products" className="bg-orange-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-orange-600 transition shadow-sm">
                  {t('orderNow')}
                </Link>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-orange-100 rounded-3xl transform rotate-2 scale-95 opacity-20 blur-2xl"></div>
              <img
      ...
      {/* CTA */}
      <section className="bg-[#faf7f2] border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4 text-stone-800">{t('ctaTitle')}</h2>
            <p className="text-xl text-stone-500 mb-8 max-w-2xl mx-auto">
              {t('ctaSubtitle')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/products" className="bg-orange-500 hover:bg-orange-600 text-white text-lg py-3 px-8 rounded-lg font-medium transition-colors shadow-sm">
                {t('browseProducts')}
              </Link>
              <Link href="/contact" className="bg-white text-stone-700 font-medium py-3 px-8 rounded-lg hover:bg-stone-50 transition-colors text-lg border border-stone-200 shadow-sm">
                {t('contactSales')}
              </Link>
            </div>
          </div>

                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8">
                        <div className="text-center mb-6">
                            <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>
                            </div>
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); handleLogin() }} className="space-y-4">
                            <input
                                ...
                                className="w-full border border-slate-300 rounded-xl px-4 py-3 text-center text-lg tracking-widest focus:ring-2 focus:ring-amber-500 outline-none"
                                autoFocus
                            />
                            <button type="submit" className="w-full py-3 bg-amber-600 text-white rounded-xl font-bold text-lg hover:bg-amber-700 transition">
                                Enter
                            </button>
                        </form>
                    </div>
                ...
                <div className="min-h-screen bg-slate-50">
                    ...
                    <div className="p-4 space-y-4 max-w-lg mx-auto">
                        ...
                        <div className="bg-white rounded-xl border p-4 shadow-sm">
                            ...
                            {addr.phone && (
                                <a href={`tel:${addr.phone}`} className="inline-flex items-center gap-2 mt-3 text-sm text-amber-700 font-semibold bg-amber-50 px-3 py-1.5 rounded-lg border border-amber-200">
                        ...
                        {isSigned ? (
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-center">
                                <svg className="w-12 h-12 text-amber-500 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                <p className="font-bold text-amber-800">Signed & Confirmed</p>
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-amber-600 text-white rounded-xl font-bold text-lg hover:bg-amber-700 transition shadow-lg shadow-amber-200"
                            >
                                Collect Signature
                            </button>
                        ) : (
                            <div id="signature-area" className="space-y-3">
                                <div className="bg-white rounded-xl border-2 border-amber-300 p-3 shadow-sm">
                                ...
                                <button
                                    ...
                                    className="w-full py-4 bg-amber-600 text-white rounded-xl font-bold text-lg hover:bg-amber-700 transition disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-amber-200"
                                >
                    ...
                    <div className="bg-white rounded-xl border p-4 shadow-sm">
                        ...
                        <div className="flex gap-2 mt-2">
                            <input
                                ...
                                className="flex-1 border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-500 outline-none"
                            />
                            <button
                            ...
                            {deliveries.map(d => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left bg-white rounded-xl border p-4 shadow-sm transition hover:shadow-md ${isSigned ? 'opacity-60 border-amber-200' : 'border-amber-200'}`}
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="flex-shrink-0 ml-3">
                                                {isSigned ? (
                                                    <span className="inline-flex items-center gap-1 bg-amber-100 text-amber-700 px-2 py-1 rounded-lg text-xs font-bold">

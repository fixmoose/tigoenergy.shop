      ...
      {modifyingOrder && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-bold text-blue-900 mb-1">Modifying Order #{modifyingOrder.orderNumber}</h3>
            <p className="text-sm text-blue-700">
              Your order has been converted back to a cart. Add or remove items, change shipping options, then proceed to checkout to place your updated order.
            </p>
            <button
              onClick={() => {

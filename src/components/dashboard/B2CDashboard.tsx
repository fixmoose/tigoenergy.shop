...
export default function B2CDashboard({ user, customer }: Props) {
    ...
    const TABS = [
        ...
        {
            id: 'docs', label: t('b2cTabs.docs'), icon: (
        ...
        <div className="flex flex-col md:flex-row gap-8 relative">
            ...
            <main className="flex-1 min-w-0 flex flex-col gap-12 pb-20">
                ...
                <section id="profile" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('profileSettings')}</h2>
                    </div>
                ...
                <section id="address" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('addressBook')}</h2>
                    </div>
                ...
                <section id="orders" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('manageOrders')}</h2>
                    </div>
                ...
                <section id="payment" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('paymentMethods')}</h2>
                    </div>
                ...
                <section id="preferences" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('communication')}</h2>
                    </div>
                ...
                <section id="docs" className="scroll-mt-[180px]">
                    <div className="mb-4">
                        <h2 className="text-lg font-bold text-gray-400 uppercase tracking-wider text-xs">{t('legalDocs')}</h2>
                    </div>

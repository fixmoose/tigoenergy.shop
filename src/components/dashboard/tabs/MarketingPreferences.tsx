        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 max-w-2xl">
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900">{t('weeklyNewsletter')}</h3>
                        <p className="text-sm text-gray-500 mt-1">{t('newsletterDesc')}</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                        <h3 className="font-semibold text-gray-900">{t('promotions')}</h3>
                        <p className="text-sm text-gray-500 mt-1">{t('promotionsDesc')}</p>
                    </div>
                </div>

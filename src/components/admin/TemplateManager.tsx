                            ...
                            <div className="flex-1 overflow-hidden bg-white shadow-inner border rounded">
                                <IframePreview
                                    html={selectedTemplate.content_html
                                        ...
                                        .replace(/\{company_iban_si\}/g, 'SI56 6100 0002 8944 371')
                                        .replace(/\{company_bic_be\}/g, 'TRWIBEB1XXX')
                                        .replace(/\{company_bic_si\}/g, 'HDELSI22')
                                        .replace(/\{company_bic\}/g, 'TRWIBEB1XXX')
